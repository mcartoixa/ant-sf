 ...
 */
public class CreateScratchTaskTest {
    ...
    public CreateScratchTaskTest() {
    }

    @Before
    public void setUp() {
        buildRule.configureProject("src/test/com/mcartoixa/ant/sf/org/create/scratch.xml", Project.MSG_DEBUG);
    }
    ...
    public void executeShouldAddTargetdevhubArgument() {
        buildRule.executeTarget("execute");
        Assert.assertTrue("Full log should contain --target-dev-hub argument", buildRule.getFullLog().contains("'--target-dev-hub'" + System.lineSeparator() + "'testdevhub'"));
    }
