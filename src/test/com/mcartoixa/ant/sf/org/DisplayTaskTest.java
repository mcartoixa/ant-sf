...
public class DisplayTaskTest {
    ...
    @Before
    public void setUp() {
        buildRule.configureProject("src/test/com/mcartoixa/ant/sf/org/display.xml", Project.MSG_DEBUG);
    }
    ...
    public void executeShouldSetResultUsernameProperty() {
        buildRule.executeTarget("execute");
        Assert.assertEquals("Username result property should set", "test@ant-sf.org", buildRule.getProject().getProperty("execute.result.username"));
    }
